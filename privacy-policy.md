...
>
> This document was prepared as a comprehensive starting draft based on the Papan Kerja codebase, data model, and Indonesian legal context (UU 27/2022 — Pelindungan Data Pribadi). It is NOT legal advice. **A qualified Indonesian lawyer must review this before you publish it.** Sections marked with `[TODO: ...]` require your input or your lawyer's confirmation. Sections marked with `⚠️ LEGAL` flag items where Indonesian law has specific requirements you should validate.
>
> Placeholders to fill in before publication:
> - `[NAMA_PENGENDALI_DATA]` — your legal name OR PT Perorangan name (the entity that controls the data)
> - `[NOMOR_REGISTRASI]` — NIB / company registration number, if applicable
> - `[ALAMAT_TERDAFTAR]` — registered address (from KTP or PT Akta)
> - `[EMAIL_KONTAK]` — public contact email (e.g., privacy@papankerja.com or kenariv12@gmail.com for v1)
> - `[EMAIL_DPO]` — Data Protection Officer email (can be same as contact email for v1; ⚠️ LEGAL: DPO designation requirements under UU PDP Art. 53 may apply due to large-scale processing of sensitive data)
> - `[TANGGAL_EFEKTIF]` — date of first publication (e.g., 2026-05-20)
...
Selamat datang di **Papan Kerja**, sebuah platform pasar (marketplace) yang menghubungkan pemberi tugas dengan pekerja harian/freelance di Indonesia. Kebijakan Privasi ini menjelaskan bagaimana **[NAMA_PENGENDALI_DATA]** ("Papan Kerja", "kami") mengumpulkan, menggunakan, menyimpan, dan melindungi data pribadi Anda saat Anda menggunakan aplikasi Papan Kerja (selanjutnya disebut "Aplikasi").

Kebijakan ini berlaku efektif sejak **[TANGGAL_EFEKTIF]** dan disusun untuk mematuhi:
...
[TODO: Konfirmasi dengan penasihat hukum apakah kategori transfer ini cukup atau apakah perlu mekanisme tambahan seperti notifikasi ke Lembaga PDP setelah lembaga tersebut terbentuk.]
...
|---|---|
| **Hak untuk mengakses dan memperoleh salinan data pribadi** | Hubungi `[EMAIL_KONTAK]` dengan subjek "Permintaan Akses Data" — kami akan menyediakan salinan data pribadi Anda dalam waktu paling lambat 3 × 24 jam |
...
| **Hak untuk menarik kembali persetujuan** | Hubungi `[EMAIL_KONTAK]` — penarikan persetujuan dapat berarti penghentian sebagian atau seluruh layanan |
...
| **Hak untuk mengajukan keberatan atas pemrosesan** | Hubungi `[EMAIL_KONTAK]` |
| **Hak untuk menunda atau membatasi pemrosesan** | Hubungi `[EMAIL_KONTAK]` |
...
[TODO: Tetapkan prosedur internal pemberitahuan insiden bersama penasihat hukum dan tim teknis sebelum peluncuran.]
...
- **Pengendali Data**: [NAMA_PENGENDALI_DATA]
- **Alamat**: [ALAMAT_TERDAFTAR]
- **Email umum**: [EMAIL_KONTAK]
- **Email Petugas Pelindungan Data (DPO)**: [EMAIL_DPO]
- **Nomor registrasi (NIB / nomor pendaftaran PSE)**: [NOMOR_REGISTRASI]

[TODO: Daftarkan Aplikasi sebagai Penyelenggara Sistem Elektronik (PSE) Privat di sistem OSS Kementerian Kominfo setelah peluncuran — wajib bagi platform yang melayani pengguna Indonesia dengan skala signifikan.]
...
Welcome to **Papan Kerja**, a marketplace platform connecting task posters with freelance/daily workers in Indonesia. This Privacy Policy explains how **[NAMA_PENGENDALI_DATA]** ("Papan Kerja", "we") collects, uses, stores, and protects your personal data when you use the Papan Kerja application (the "App").

This policy is effective as of **[TANGGAL_EFEKTIF]** and is designed to comply with:
...
|---|---|
| Right to access and obtain a copy of personal data | Contact `[EMAIL_KONTAK]` with the subject "Data Access Request" — we will provide a copy of your personal data within 3 × 24 hours |
...
| Right to withdraw consent | Contact `[EMAIL_KONTAK]` — withdrawal of consent may mean partial or complete termination of service |
...
| Right to object to processing | Contact `[EMAIL_KONTAK]` |
| Right to delay or restrict processing | Contact `[EMAIL_KONTAK]` |
...
- **Data Controller**: [NAMA_PENGENDALI_DATA]
- **Address**: [ALAMAT_TERDAFTAR]
- **General email**: [EMAIL_KONTAK]
- **Data Protection Officer (DPO) email**: [EMAIL_DPO]
- **Registration number (NIB / PSE registration number)**: [NOMOR_REGISTRASI]
